          ...
          <fieldset>
            ...
            <div className="item">
              <div className="item">
                ...
                <select>
                  <option value={1} disabled selected>Choose your cause</option>
                  <option value={2}>Bright Spark Education Program</option>
                  <option value={3}>Transformers</option>
                  <option value={4}>Food and Nutrition Programm</option>
                  <option value={5}>Gender Program </option>
                  <option value={6}>Youngistaan Animal Heroes</option>
                  <option value={7}>Blood Donor</option>
                </select>
                <span>*</span>
              </div>
              <div className="columns">
                <label htmlFor="ParicipatedDate">Participated Date<span>*</span></label>
                <input id="ParicipatedDate" type="date" name="ParicipatedDate" />
            ...
            <div className="item">
              ...
              <textarea id="instruction" rows={5} defaultValue={""} />
            </div>
            <div className="item">
