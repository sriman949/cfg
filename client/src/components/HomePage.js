...
function HomePage() {
  ...
  return (
    <div>
      <header>
        <Navbar />
        <Grid container spacing={2} style={{ justifyContent: "center" , marginTop : "60px"}}>
        <Grid item xs={3} className={classes.griditem}>
          <TopCards name="Volunteers" sub="170 (Weekly)" up={true} per="6.73" role="1"/>
        </Grid>
        <Grid item xs={1}></Grid>
        <Grid item xs={3} className={classes.griditem}>
